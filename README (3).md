...
A reinforcement learning agent that learns to play competitive Pokémon battles (Gen 9 Random Battles) on [Pokémon Showdown](https://pokemonshowdown.com/), built with [poke-env](https://github.com/hsahovic/poke-env) and [Stable-Baselines3](https://github.com/DLR-RM/stable-baselines3).
